    ...
    _Blob = (_a = class {
      ...
      constructor(blobParts = [], options = {}) {
        ...
        for (const element2 of blobParts) {
          ...
          } else if (element2 instanceof _a) {
            part = element2;
          } else {
...
var ResizeObserverSingleton = class _ResizeObserverSingleton {
  ...
  _getObserver() {
    var _a4;
    return (_a4 = this._observer) != null ? _a4 : this._observer = new ResizeObserver((entries) => {
      var _a5;
      for (const entry of entries) {
        _ResizeObserverSingleton.entries.set(entry.target, entry);
        (_a5 = this._listeners.get(entry.target)) == null ? void 0 : _a5(entry);
      }
    });
  }
};
...
function get_custom_element_value(prop, value, props_definition, transform) {
  var _a4;
  const type = (_a4 = props_definition[prop]) == null ? void 0 : _a4.type;
...
var SettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("ASP.NET_SessionId=").addText((text2) => text2.setPlaceholder("Enter your SessionId").setValue(this.plugin.settings.sessionId).onChange(async (value) => {
